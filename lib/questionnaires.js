...
//
// There are no FieldLevel rows in this file any more. All 116 were removed on
// 2026-09-11, and the reason is worth keeping because the surface evidence
// argued the other way.
//
// The first check, on 2026-09-07, found that /recruiting 302s to fieldlevel's
// homepage. That turned out to be true of only three of the 116. The other 113
// return HTTP 200 with a title reading exactly "<School> <Sport> Recruiting
// Questionnaire" — correct school, correct sport, no redirect. Every automated
// test passes.
//
// Render one and there is no questionnaire on it. The page says "<School>
// would like you to complete a FieldLevel recruiting profile", every button
// goes to fieldlevel.com/join, and a section headed "Where's the
// questionnaire?" answers: "Standard recruiting questionnaires and prospect
// forms get out of date very quickly." So the destination is a competitor's
// account-signup wall, carrying an argument against this entire catalogue,
// reached from inside our own product. Three of the 116 are additionally
// broken, landing on "Sorry, something went wrong".
//
// The lesson generalises past FieldLevel: a 200, a correct <title>, and no
// redirect are not evidence that a link leads to a form. Only rendering is.
// These rows survived two earlier passes because they answered every cheap
// question correctly.
//
// Of the 116, 35 were replaced with the school's own form. Ten of those were
// forms the 2026-09-11 state sweeps had already found and silently discarded,
// because a FieldLevel row already occupied that school+gender+sport key — so
// a bad row was actively blocking a good one. When removing rows in bulk,
// re-check earlier sweep output for candidates the removed rows had shadowed.
//
// The remaining 81 had no school-run replacement and were deleted, which costs
// this file 22 schools entirely — Baker, Central Connecticut, Oakland, Ohio
// Northern, Rhode Island College, Wittenberg and sixteen more. Some of those
// programmes genuinely recruit through FieldLevel and have no form of their
// own. They can come back if they ever publish one. Absence beats a link that
// spends a recruit's click on a competitor's signup page.
//
...
//
// Arizona was re-swept on 2026-09-21, prompted by a coach who follows Jamario:
// 14 rows became 32. What the sweep turned up, beyond the rows themselves:
//
//   - Grand Canyon is BACK. Its department died with questionnaire.frontrush.com
//     (see below), and it now runs one athletics-wide form at gculopes.com/form/94
//     with a populated sport dropdown — the McNeese pattern, ten rows on one URL.
//     A dead host is worth re-checking after a few months; schools do move.
//   - Northern Arizona lists every sport's form on one page,
//     nauathletics.com/sports/2017/6/6/recruiting-contacts-and-questionnaires.aspx,
//     but the anchors all read "Questionnaire" and the ARMS pages render their
//     titles in JavaScript, so curl sees "Welcome to Teamworks" for all of them.
//     Each hash had to be opened in a browser to learn which sport it is.
//   - Ottawa Arizona sends basketball recruits to a coach's mailbox rather than
//     a form, and its women's volleyball FrontRush link now answers "This
//     questionnaire is no longer available". Its CaptainU soccer/tennis forms
//     and its track questionnaire are live. Four platforms, one school.
//   - Arizona and Arizona State have no public men's basketball form: Arizona's
//     recruit-form page 404s and ASU links none. Normal for high-major hoops.
//   - Arizona's junior colleges could not be checked at all. awcmatadors.com,
//     pimaaztecs.com and the Maricopa district sites answer 403 from CloudFront
//     to curl AND to a real browser, so their forms — if any — stay unknown
//     rather than unlisted-because-absent.
//
...
// Link-rot check, 2026-09-11: all 1,132 ARMS hashes re-resolved through the
// public API and all 124 JumpForward slots re-fetched. Five rows were dead and
// have been removed — Arizona State football (ARMS hash now 404s), and four
// JumpForward slots whose whole institution id has been decommissioned: Oregon
// football (iid=510), UConn men's tennis (iid=331), USF men's and women's
// tennis (iid=454, every sportid on it now answers "The URL entered appears to
// be invalid").
//
// Two things that check taught, both worth repeating rather than rediscovering:
//
//   - 5 dead out of 1,256 is a ~0.4% annual rot rate, so this is a once-a-season
//     job, not a constant worry. ARMS is the durable platform (1 dead in 1,132);
//     JumpForward is where the rot is (4 in 124, all of it whole accounts being
//     switched off rather than individual forms).
//   - UConn and USF still link those dead JumpForward URLs from their own sport
//     pages today. The rot is theirs, not ours — which means "the school still
//     publishes it" is not evidence a link works, and there is often no
//     replacement to move to. All five schools were checked for one; none had
//     a public questionnaire for that sport any more.
...
export const QUESTIONNAIRES = [
  ...
  ["Grand Canyon University","AZ","D1","Men","Baseball","https://gculopes.com/form/94"],
  ...
  ["Grand Canyon University","AZ","D1","Women","Basketball","https://gculopes.com/form/94"],
  ["Grand Canyon University","AZ","D1","Men","Basketball","https://gculopes.com/form/94"],
  ...
  ["Northern Arizona University","AZ","D1","Men","Basketball","https://questionnaires.armssoftware.com/b90ca40dde28"],
  ["Northern Arizona University","AZ","D1","Women","Basketball","https://questionnaires.armssoftware.com/1adca3872f14"],
  ...
  ["University of Georgia","GA","D1","Men","Basketball","https://questionnaires.armssoftware.com/41d8691a008a"],
  ...
  ["University of West Florida","FL","D2","Men","Basketball","https://goargos.com/sb_output.aspx?form=3"],
  ["University of West Florida","FL","D2","Women","Basketball","https://goargos.com/sb_output.aspx?form=3"],
  ...
  ["Western Oregon University","OR","D2","Men","Basketball","https://wouwolves.com/sb_output.aspx?form=6"],
  ...
  ["Northern Arizona University","AZ","D1","Men","Football","https://questionnaires.armssoftware.com/8f95299bab36"],
  ...
  ["University of West Florida","FL","D2","Men","Football","https://goargos.com/sb_output.aspx?form=3"],
  ...
  ["College of Southern Nevada","NV","JUCO","Men","Soccer","https://csncoyotes.com/sb_output.aspx?form=3"],
  ...
  ["Fordham University","NY","D1","Men","Soccer","https://fordhamsports.com/sb_output.aspx?form=3"],
  ...
  ["Grand Canyon University","AZ","D1","Women","Soccer","https://gculopes.com/form/94"],
  ["Grand Canyon University","AZ","D1","Men","Soccer","https://gculopes.com/form/94"],
  ...
  ["Middle Georgia State University","GA","NAIA","Men","Soccer","https://mgaknights.com/sb_output.aspx?form=3"],
  ...
  ["Mississippi State University","MS","D1","Women","Soccer","https://hailstate.com/sb_output.aspx?form=2041"],
  ["Mississippi Valley State University","MS","D1","Women","Soccer","https://mvsusports.com/sb_output.aspx?form=3"],
  ["Missouri State University","MO","D1","Men","Soccer","https://questionnaires.armssoftware.com/96842adff667"],
  ...
  ["Northern Arizona University","AZ","D1","Women","Soccer","https://questionnaires.armssoftware.com/bde5299804f6"],
  ...
  ["Ottawa University Arizona","AZ","NAIA","Women","Soccer","https://college.captainu.com/ottawa-university-arizona/womens/soccer/questionnaire"],
  ["Ottawa University Arizona","AZ","NAIA","Men","Soccer","https://college.captainu.com/ottawa-university-arizona/mens/soccer/questionnaire"],
  ...
  ["Seattle University","WA","D1","Men","Soccer","https://college.jumpforward.com/questionnaire.aspx?iid=1735&sportid=21"],
  ...
  ["University of Central Arkansas","AR","D1","Men","Soccer","https://ucasports.com/sb_output.aspx?form=3"],
  ...
  ["University of Kansas","KS","D1","Women","Soccer","https://questionnaires.armssoftware.com/b1ebc7ac5fb8"],
  ...
  ["University of Maryland Baltimore County","MD","D1","Men","Soccer","https://umbcretrievers.com/sb_output.aspx?form=3"],
  ["University of Maryland Baltimore County","MD","D1","Women","Soccer","https://umbcretrievers.com/sb_output.aspx?form=3"],
  ...
  ["University of Memphis","TN","D1","Men","Soccer","https://questionnaires.armssoftware.com/07289827bc79"],
  ...
  ["University of New Hampshire","NH","D1","Men","Soccer","https://questionnaires.armssoftware.com/320e78d07bcc"],
  ["University of New Hampshire","NH","D1","Women","Soccer","https://questionnaires.armssoftware.com/6c09cf822039"],
  ...
  ["University of Pennsylvania","PA","D1","Men","Soccer","https://questionnaires.armssoftware.com/65667b0c1c91"],
  ...
  ["University of South Florida","FL","D1","Men","Soccer","https://college.jumpforward.com/questionnaire.aspx?iid=1625&sportid=21"],
  ...
  ["University of Southern Indiana","IN","D1","Men","Soccer","https://questionnaires.armssoftware.com/c037d549bfc8"],
  ...
  ["University of Texas at Tyler","TX","D2","Men","Soccer","https://questionnaires.armssoftware.com/10a6774a8977"],
  ...
  ["University of West Florida","FL","D2","Men","Soccer","https://goargos.com/sb_output.aspx?form=3"],
  ["University of West Florida","FL","D2","Women","Soccer","https://goargos.com/sb_output.aspx?form=3"],
  ["University of Wisconsin","WI","D1","Men","Soccer","https://college.jumpforward.com/questionnaire.aspx?iid=444&sportid=21"],
  ...
  ["Virginia Tech","VA","D1","Women","Soccer","https://questionnaires.armssoftware.com/dae9b53f2736"],
  ...
  ["College of Southern Nevada","NV","JUCO","Women","Softball","https://csncoyotes.com/sb_output.aspx?form=3"],
  ...
  ["Grand Canyon University","AZ","D1","Women","Softball","https://gculopes.com/form/94"],
  ...
  ["Middle Georgia State University","GA","NAIA","Women","Softball","https://mgaknights.com/sb_output.aspx?form=3"],
  ...
  ["Seattle University","WA","D1","Women","Softball","https://college.jumpforward.com/questionnaire.aspx?iid=1735&sportid=31"],
  ...
  ["University of Central Arkansas","AR","D1","Women","Softball","https://ucasports.com/sb_output.aspx?form=3"],
  ...
  ["University of Maryland Baltimore County","MD","D1","Women","Softball","https://umbcretrievers.com/sb_output.aspx?form=3"],
  ...
  ["University of New Mexico","NM","D1","Women","Softball","https://questionnaires.armssoftware.com/e82b87a57fa8"],
  ...
  ["University of Pennsylvania","PA","D1","Women","Softball","https://questionnaires.armssoftware.com/d466c14eb78f"],
  ...
  ["University of South Carolina Upstate","SC","D1","Women","Softball","https://questionnaires.armssoftware.com/8747ccb9a81b"],
  ["University of South Dakota","SD","D1","Women","Softball","https://college.jumpforward.com/questionnaire.aspx?iid=453&sportid=31"],
  ["University of South Florida","FL","D1","Women","Softball","https://questionnaires.armssoftware.com/c6cbb1c745a1"],
  ["University of Southern Indiana","IN","D1","Women","Softball","https://questionnaires.armssoftware.com/614cd4dc0196"],
  ...
  ["University of Texas at Tyler","TX","D2","Women","Softball","https://questionnaires.armssoftware.com/6919e39004cb"],
  ...
  ["University of Wisconsin","WI","D1","Women","Softball","https://questionnaires.armssoftware.com/379e17a4c05f"],
  ...
  ["Duke University","NC","D1","Women","Tennis","https://questionnaires.armssoftware.com/66e15128b388"],
  ...
  ["Grand Canyon University","AZ","D1","Women","Tennis","https://gculopes.com/form/94"],
  ["Grand Canyon University","AZ","D1","Men","Tennis","https://gculopes.com/form/94"],
  ...
  ["Northern Arizona University","AZ","D1","Women","Tennis","https://questionnaires.armssoftware.com/d6be1814f0aa"],
  ...
  ["Ottawa University Arizona","AZ","NAIA","Men","Tennis","https://college.captainu.com/ottawa-university-arizona/mens/tennis/questionnaire"],
  ...
  ["University of West Florida","FL","D2","Women","Tennis","https://goargos.com/sb_output.aspx?form=3"],
  ...
  ["Grand Canyon University","AZ","D1","Both","Track & Field","https://gculopes.com/form/94"],
  ...
  ["Ottawa University Arizona","AZ","NAIA","Both","Track & Field","https://ouazspirit.com/sb_output.aspx?form=35"],
  ...
  ["Grand Canyon University","AZ","D1","Women","Volleyball","https://gculopes.com/form/94"],
  ...
  ["University at Buffalo","NY","D1","Women","Volleyball","https://questionnaires.armssoftware.com/f861e985364d"],
  ...
  ["University of New Hampshire","NH","D1","Women","Volleyball","https://questionnaires.armssoftware.com/d204dd0f198e"],
  ["University of New Mexico","NM","D1","Women","Volleyball","https://questionnaires.armssoftware.com/fbeb2eb5d4dd"],
  ...
  ["University of West Florida","FL","D2","Women","Volleyball","https://goargos.com/sb_output.aspx?form=3"],
  ...
  ["West Virginia University","WV","D1","Women","Volleyball","https://questionnaires.armssoftware.com/7d50073a7dd2"],
  ...
  ["Winston-Salem State University","NC","D2","Women","Volleyball","https://questionnaires.armssoftware.com/06abbcb776d3"],
