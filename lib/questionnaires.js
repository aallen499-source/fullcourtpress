...
// women's programme. NWAC's own team pages looked like the fix — a 200 at
// /sports/<code>/<season>/teams/<school> means that school fields it — but the
// control failed: Columbia Basin came back with no softball and no volleyball
// while its own site serves a form for each. The sport codes or the season
// segment are wrong, and until that probe agrees with a school we can check by
// hand, it is not a source. Yakima Valley, Lower Columbia and Southwestern
// Oregon are held back on exactly that.
//
