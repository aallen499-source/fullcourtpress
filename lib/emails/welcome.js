...
export function welcomeEmail({ loginEmail } = {}) {
  ...
  const freeRows = [
    'A 3-minute setup and your shareable profile link',
    'Links to the coaching staff at 1,200+ colleges',
    'All 13 email templates, sent from your own inbox',
    'An email when a coach opens your profile',
    'Up to 10 coaches, and unlimited YouTube and Hudl film links',
  ]
    .map(
      (item) => `
