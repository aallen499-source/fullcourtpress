...
export const GUIDES = [
  {
    ...
    faqs: [
      { q: 'How long should an email to a college coach be?', a: 'Short enough to read on a phone between practices — roughly 150 words. Grad year, position, height, school and a film link in the first two lines, one sentence about why that program, and a question at the end.' },
      { q: 'Should the parent or the athlete send the email?', a: 'The athlete, from their own address. Draft it together if that helps, but coaches want to recruit the player, and an email from a parent\'s account reads as the parent running the process.' },
      { q: 'What do you do if a coach doesn\'t reply?', a: 'Assume they are busy rather than uninterested, and follow up in two to three weeks with something new — a new highlight, a schedule, a season update. Two or three follow-ups over a season is normal, not pushy.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Can you email a college coach as a freshman?', a: 'Yes. The rules restrict when coaches may contact athletes, not when athletes may contact coaches. An email sent at any age is allowed — a coach may simply not be permitted to reply yet.' },
      { q: 'Why would a coach not reply to a younger athlete?', a: 'In several Division I and II sports, staff cannot respond personally until a set date, usually in the athlete\'s sophomore or junior year. Silence at that stage is usually the calendar, not a verdict.' },
      { q: 'Do Division III and NAIA have the same contact rules?', a: 'No. Division III and the NAIA are far less restricted, which is why younger athletes often hear back from those coaches first.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Which levels can offer athletic scholarships?', a: 'Division I, Division II, the NAIA and junior colleges can. Division III cannot offer athletic money at all, though academic and need-based aid at those schools is often substantial.' },
      { q: 'Is Division III worse than Division II?', a: 'Not as a playing experience — good Division III programs beat Division II teams regularly. The difference is how the money works and how much time the sport takes.' },
      { q: 'Who do you register with to be eligible?', a: 'Division I and II use the NCAA Eligibility Center, the NAIA has its own eligibility centre, and junior colleges set their own standards. Division III has no central registration.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Does a camp invitation mean a college is recruiting you?', a: 'Usually not. Most invitations go to every name in a program\'s database. An invitation that mentions where they saw you play is a different thing entirely.' },
      { q: 'When is a prospect camp worth the money?', a: 'When coaches from schools on your realistic list will be there, the group is small enough to be seen, and you email the staff beforehand to say you are coming.' },
      { q: 'What should you do after a camp?', a: 'Email the coaches who ran your group within a few days, mention something specific from the day, and attach film. The follow-up is worth more than the camp.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'When should recruiting start?', a: 'Grades and core courses from the first day of ninth grade, because they decide eligibility later. Serious outreach usually begins in sophomore year, though there is no wrong time to start.' },
      { q: 'Is junior year too late to start?', a: 'No. Division II, Division III, NAIA and junior college coaches recruit later and keep recruiting through senior year, and many rosters are still being filled in the spring.' },
      { q: 'What matters most in senior year?', a: 'Applying to the schools talking to you, filing financial aid forms on time, keeping your transcript clean, and continuing to email coaches at levels that recruit late.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Does filling out a questionnaire mean you are being recruited?', a: 'No. It puts your information in a program\'s database, which is where recruiting starts rather than proof of it. It is still worth doing, and it is free.' },
      { q: 'How many questionnaires should you fill out?', a: 'One for every school you would genuinely attend. Ten to twenty is a normal number, and it is worth keeping a record of which ones you have sent.' },
      { q: 'Should you use the athlete\'s email or a parent\'s?', a: 'The athlete\'s. Everything that follows — camp invitations, replies, newsletters — goes to whatever address is typed into the form.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'How many NCAA core courses do you need?', a: 'Sixteen for both Division I and Division II, in set subject areas, with a qualifying core-course GPA and a final transcript sent to the Eligibility Center.' },
      { q: 'What is the 10/7 rule?', a: 'A Division I requirement that ten of the sixteen core courses, including seven in English, maths and science, are finished before the start of senior year. Grades in those ten are locked once the seventh semester begins.' },
      { q: 'Do Division III and NAIA use core courses?', a: 'No. Division III sets admission and eligibility standards school by school, and the NAIA has its own requirements through its eligibility centre.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'How long should a highlight video be?', a: 'Two to four minutes. Coaches often decide within the first thirty seconds, so the best five or six plays belong at the front rather than saved for the end.' },
      { q: 'Do coaches want full game film as well?', a: 'Yes, once they are interested. Highlights get you watched; full games show how you play when nothing is happening, which is what actually gets evaluated.' },
      { q: 'How do coaches know which player is you?', a: 'You tell them in every clip — an arrow, a circle or a spotlight at the start of the play, and a title card with your name, grad year, position and school.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Should the athlete or the parent answer the call?', a: 'The athlete. A parent can be in the room and can join at the end, but a coach is calling to hear how the player talks, thinks and answers.' },
      { q: 'What questions should you ask a college coach?', a: 'Ask about your role and the players they are recruiting at your position, what a normal week looks like in and out of season, and what the school costs after aid.' },
      { q: 'What happens after the call?', a: 'Send a short thank-you the same day, answer anything you promised to send, and write down what was said — in three months those details are what make the next conversation easy.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'What should a parent do in the recruiting process?', a: 'The organising — deadlines, film logistics, travel, money questions and keeping track of who has been contacted — while the athlete does the talking and the emailing.' },
      { q: 'Do coaches mind talking to parents?', a: 'Not at all, about the right things: cost, academics, safety, travel. What costs opportunities is a parent answering questions asked of the athlete.' },
      { q: 'What is the most common parent mistake?', a: 'Sending the emails themselves. Coaches notice immediately, and it raises the one question they cannot ask out loud — whether the athlete wants this.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Do college coaches really check social media?', a: 'Assume every coach recruiting you will look. It costs them two minutes, and it is the cheapest character reference available to them.' },
      { q: 'What on social media costs an athlete an offer?', a: 'Anything a coach would have to explain to an athletic director: fights, slurs, drink and drugs, running down teammates or officials, and arguing in comments.' },
      { q: 'What should an athlete post instead?', a: 'A clear photo, a bio with grad year, position, school and film link, and the ordinary things — workouts, team wins, academic news. It does not need to be a highlight reel.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Do most college athletes get a full ride?', a: 'No. Outside a handful of sports at the top of Division I, most athletic aid is partial, and many athletes combine it with academic and need-based money.' },
      { q: 'Can Division III schools offer athletic money?', a: 'No, but the academic and need-based aid can be large enough that a Division III school costs a family less than a partial scholarship elsewhere.' },
      { q: 'How should families compare offers?', a: 'On what you would actually pay after all aid, for all four years — not on the percentage of a scholarship. Ask each school for the net cost in writing.' },
    ],
  ...
  },
  {
    ...
    faqs: [
      { q: 'Is junior college a step down?', a: 'No. It is a way to play immediately, improve, raise a GPA and cost less, then transfer with tape and a transcript that prove it.' },
      { q: 'Do junior colleges offer scholarships?', a: 'Many do, at some levels covering tuition, books and sometimes housing. What is available varies by division and by state.' },
      { q: 'When do junior college coaches recruit?', a: 'Late, and for longer — junior college rosters are still being filled through spring and summer, which makes them the list that is still live when others have closed.' },
    ],
  ...
  {
    slug: 'how-college-recruiting-works',
    faqs: [
      { q: 'How do college coaches build their recruiting lists?', a: 'From camps, questionnaires, film sent to them, events they attend, and coaches they trust. For most programs the list starts at hundreds of names per class.' },
      { q: 'Is a verbal offer binding?', a: 'No. A verbal offer binds neither side and can be withdrawn — staff change, classes fill. The document that matters is a written offer of athletics aid, which states the money and the term.' },
      { q: 'What actually decides it at the end?', a: 'Eligibility. Core courses, a qualifying GPA and a final transcript decide whether recruiting turns into a roster spot, and athletes lose places here every year.' },
    ],
    title: 'How College Recruiting Actually Works, From the Coach’s Side',
    description:
      'The five stages a college coach moves through — building a list, first contact, evaluation, offers, signing — and what an athlete should be doing at each one.',
    updated: '2026-09-17',
    readMinutes: 8,
    shortAnswer:
      'Coaches build a long list, contact it broadly, evaluate a much shorter list in person and on film, make offers to a handful, and sign the ones who say yes and are eligible. An athlete’s job is to get onto the list early, make evaluation easy, and keep grades clean — because the last stage is decided by a transcript, not a highlight video.',
    sections: [
      {
        heading: 'Stage 1: The list',
        blocks: [
          { type: 'p', text: 'Long before anyone is recruited, a staff builds a list of names for each graduating class: players they’ve seen, players their contacts mention, names from questionnaires and camp rosters, and film that landed in the inbox. For most programs that list is hundreds of names long.' },
          { type: 'p', text: 'What gets you on it: a questionnaire submitted, an email with film, a camp at that school, or a high school or club coach who calls on your behalf. None of that means you’re being recruited — it means you exist to them, which is the first requirement.' },
          { type: 'note', text: 'Your job at this stage: be on more lists. Email the coaches yourself, submit questionnaires, and keep your film current.' },
        ],
      },
      {
        heading: 'Stage 2: First contact — and what it does and doesn’t mean',
        blocks: [
          { type: 'p', text: 'Programs send a lot of mail: camp invitations, general letters, questionnaires, occasional social media follows. Most of it goes to the whole list. It is not an offer, and it usually isn’t personal.' },
          { type: 'list', items: [
            'A form letter or camp invite means you’re in the database.',
            'A message that names where they saw you play, and what they liked, means a person is paying attention.',
            'A reply to something you sent is worth more than anything unsolicited.',
          ] },
          { type: 'p', text: 'Answer everything that comes from a school you would actually attend, within a day or two, from the athlete’s own email. Ask a direct question back: are you evaluating my position in my class?' },
        ],
      },
      {
        heading: 'Stage 3: Evaluation',
        blocks: [
          { type: 'p', text: 'The list gets cut. Coaches watch film, come to games and events, run camps to see players in person, and start phone calls. They are judging more than skill: how you move without the ball, how you respond to a mistake, how you treat teammates, whether your body will hold up, and whether your grades work.' },
          { type: 'list', items: [
            'Make evaluation easy: film that’s current, clearly marked, and quick to open; a schedule they can plan around; honest measurements.',
            'Tell coaches where you’ll be playing before tournaments and showcases.',
            'Expect quiet stretches. Coaches watch far more players than they speak to.',
          ] },
        ],
      },
      {
        heading: 'Stage 4: Offers',
        blocks: [
          { type: 'p', text: 'An offer can mean several different things, so ask plainly what is being offered.' },
          { type: 'list', items: [
            'A verbal offer is a coach saying they want you, often with athletic aid attached. It is not binding on either side, and it can be withdrawn — coaches move, classes fill, staffs change.',
            'A written offer of athletics aid is the real document. It says what money you get and for how long.',
            'A roster spot or preferred walk-on spot means a place on the team without athletic aid. That can still be a great outcome, especially where academic or need-based aid is strong.',
          ] },
          { type: 'p', text: 'Ask what the offer covers, for how long, what happens if you’re injured or the coach leaves, and when they need an answer. Get the terms in writing before you decide.' },
        ],
      },
      {
        heading: 'Stage 5: Signing and eligibility',
        blocks: [
          { type: 'p', text: 'How signing works changed recently: the National Letter of Intent program ended in Division I in 2024, and athletes there now sign a written offer of athletics aid instead. Division II still uses the NLI. Ask each school exactly what you will sign, what it commits you to, and what it commits them to.' },
          { type: 'p', text: 'Then eligibility decides it. For Division I and II that means NCAA-approved core courses, a qualifying core-course GPA, and a final transcript with proof of graduation sent to the Eligibility Center; NAIA and junior colleges have their own standards. Every year, athletes lose spots here after the recruiting was already done.' },
        ],
      },
      {
        heading: 'What this means for how you spend your time',
        blocks: [
          { type: 'list', items: [
            'Early years: grades and core courses, film, and getting on lists.',
            'Middle years: emails, questionnaires, camps at schools you’d attend, and answering fast when someone replies.',
            'Late: narrowing to programs that talk to you, asking hard questions about money and role, and keeping your transcript clean.',
            'Throughout: keep Division II, III, NAIA and junior college schools on your list. Most college athletes play outside Division I, and those coaches recruit later and longer.',
          ] },
        ],
      },
    ],
    ...
    cta: {
      title: 'Work the process, not the wait',
      text: 'RecruitGrid keeps your schools in three lanes, links each one’s coaching staff, gives you the emails to send, and tells you when a coach opens your profile.',
      button: 'Start free',
      href: '/app',
    },
  },
