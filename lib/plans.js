...
export const PLANS = [
  {
    ...
    features: ['Up to 10 coaches, with links to each school’s coaching staff', 'All 13 email templates, and writing to several coaches at once', 'Alerts when a coach opens your profile', 'Next-step reminders, daily to-do list and monthly checklist', 'Sunday update for a parent', 'Unlimited YouTube & Hudl film links, 2 uploaded videos'],
  },
  {
...
export const COMPARISON = {
  ...
  rows: [
    ...
    ['Email templates + drafts', 'All 13', 'All 13', 'All 13', 'All 13'],
    ['Coaching staff links (1,200+ colleges)', 'Yes', 'Yes', 'Yes', 'Yes'],
    ['“Coach opened your profile” alerts', 'Yes', 'Yes', 'Yes', 'Yes'],
    ['Next-step reminders + daily to-do list', 'Yes', 'Yes', 'Yes', 'Yes'],
    ['Monthly checklist + Sunday parent update', 'Yes', 'Yes', 'Yes', 'Yes'],
    ...
    ['Verified camp list', 'Names & dates', 'Yes', 'Yes', 'Yes'],
